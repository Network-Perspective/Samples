...
class MetricsExportParamsResult(BaseModel):
    """
    MetricsExportParamsResult
    """ # noqa: E501
    periods: Optional[List[StrictStr]] = None
    metrics: Optional[List[StrictStr]] = None
    related_metrics: Optional[List[StrictStr]] = Field(default=None, alias="relatedMetrics")
    categories: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["periods", "metrics", "relatedMetrics", "categories"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "relatedMetrics": obj.get("relatedMetrics"),
