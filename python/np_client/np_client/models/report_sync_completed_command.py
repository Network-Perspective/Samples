...
class ReportSyncCompletedCommand(BaseModel):
    """
    ReportSyncCompletedCommand
    """ # noqa: E501
    service_token: Optional[StrictStr] = Field(default=None, alias="serviceToken")
    sync_period_start: Optional[datetime] = Field(default=None, alias="syncPeriodStart")
    sync_period_end: Optional[datetime] = Field(default=None, alias="syncPeriodEnd")
    success: Optional[StrictBool] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["serviceToken", "syncPeriodStart", "syncPeriodEnd", "success", "message"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "syncPeriodStart": obj.get("syncPeriodStart"),
            "syncPeriodEnd": obj.get("syncPeriodEnd"),
