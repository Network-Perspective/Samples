...
class SyncHashedEntitesCommand(BaseModel):
    """
    SyncHashedEntitesCommand
    """ # noqa: E501
    service_token: Optional[StrictStr] = Field(default=None, alias="serviceToken")
    entites: Optional[List[HashedEntity]] = None
    __properties: ClassVar[List[str]] = ["serviceToken", "entites"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in entites (list)
        _items = []
        if self.entites:
            for _item in self.entites:
                if _item:
                    _items.append(_item.to_dict())
            _dict['entites'] = _items
        ...
        # set to None if entites (nullable) is None
        # and model_fields_set contains the field
        if self.entites is None and "entites" in self.model_fields_set:
            _dict['entites'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "entites": [HashedEntity.from_dict(_item) for _item in obj.get("entites")] if obj.get("entites") is not None else None
        })
        return _obj
