...
class SyncHashedGroupStructureCommand(BaseModel):
    """
    SyncHashedGroupStructureCommand
    """ # noqa: E501
    service_token: Optional[StrictStr] = Field(default=None, alias="serviceToken")
    groups: Optional[List[HashedGroup]] = None
    __properties: ClassVar[List[str]] = ["serviceToken", "groups"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [HashedGroup.from_dict(_item) for _item in obj.get("groups")] if obj.get("groups") is not None else None
        })
        return _obj
