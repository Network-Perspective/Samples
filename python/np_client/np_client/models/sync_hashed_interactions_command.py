...
class SyncHashedInteractionsCommand(BaseModel):
    """
    SyncHashedInteractionsCommand
    """ # noqa: E501
    service_token: Optional[StrictStr] = Field(default=None, alias="serviceToken")
    interactions: Optional[List[HashedInteraction]] = None
    __properties: ClassVar[List[str]] = ["serviceToken", "interactions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if interactions (nullable) is None
        # and model_fields_set contains the field
        if self.interactions is None and "interactions" in self.model_fields_set:
            _dict['interactions'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "interactions": [HashedInteraction.from_dict(_item) for _item in obj.get("interactions")] if obj.get("interactions") is not None else None
        })
        return _obj
