...
class UserEntity(BaseModel):
    ...
    group_access: Optional[List[StrictStr]] = Field(default=None, alias="groupAccess")
    __properties: ClassVar[List[str]] = ["email", "ids", "props", "groupAccess"]
